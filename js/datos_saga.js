...
window.SAGA_DATA = [
  {
    ...
    sinopsis: "Kaira siempre deseó tener magia, pero nunca imaginó que fuera real. Un viaje inesperado la lleva a descubrir una verdad imposible.",
  ...
  },
  {
    ...
    frase: "Lo robado exige ser devuelto, pero en el camino la sombra acecha.",
  ...
  },
  {
    ...
    frase: "La aprobación de los antiguos dioses solo llega superando las pruebas",
    imagen: "imagenes_principal/saga/libro3_banner.jpg",
  ...
  },
  {
    ...
    frase: "Toda recolección esconde una revelación que no pediste",
  ...
  },
  {
    ...
    frase: "Así como los secretos pueden ser leídos, los elegidos no siempre son los esperados.",
  ...
  },
{
  id: "libro-6",
    ...
    frase: "Hay verdades que no se revelan sino hasta que los tres convergen.",
  ...
  },
{
  id: "libro-8",
    ...
    frase: "Lo que los antiguos dejaron disperso es lo único que puede detener su regreso.",
  ...
  id: "libro-9",
    ...
    frase: "Lo que nadie enseña es lo que hay que aprender antes de la prueba final.",
